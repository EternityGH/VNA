            ...
            />
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: windowHeight/25, paddingHorizontal: 15, paddingTop: 10}}>
                    <TouchableOpacity 
                        ...
                        <LinearGradient 
                                ...
                                colors={['#07ad87', '#48ab94', '#07ad87', '#48ab94' ]}
                    ...
                    <TouchableOpacity 
                        ...
                        style={{width: windowWidth/2.3}}>
                        <View style={{alignItems: 'center', borderColor: '#07ad87', borderWidth: 2, padding: windowWidth/38, width: '100%', borderRadius: 20}}>
                                <Text style={{color: '#07ad87'}}>{checkLanguage({vi: 'RÚT', en: `WITHDRAW`},language)}</Text>
                        </View>
                    </TouchableOpacity>
                </View>   
                ...
                <View style={{padding: 20}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'center', paddingBottom: 10}}>
                        <View>
                            <Text style={{color: '#07ad87', fontSize: 18, fontWeight: 'bold'}}>{checkLanguage({vi: 'Lịch sử', en: `Transaction`},language)}</Text>
                        </View>
                        
                    </View>
                    {  Loading === true ?  <ActivityIndicator size="small" color="#07ad87" />
                    ...
                    
                    {
                        ...
                        <View style={{paddingTop: 20, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', paddingBottom: 20}}>
                            <TouchableOpacity onPress={() => leftArrowHandler(Skip)}>
                                <FontAwesomeIcon size={40} color={display === 1 ? '#07ad87' : "rgba(255,255,255,0.6)"} icon={faAngleLeft}/>
                            </TouchableOpacity>
                                <Text style={{color: display === 1 ? '#07ad87' :  'rgba(255,255,255,0.6)', fontSize: 20, paddingHorizontal: 20}}>{Skip+1 + '/' + ( Math.ceil(Transaction.length/5))}</Text>
                            <TouchableOpacity onPress={() =>  rightArrowHandler(Skip)}>
                                <FontAwesomeIcon size={40} color={display === 1 ? '#07ad87' : "rgba(255,255,255,0.6)"} icon={faAngleRight}/>
                            </TouchableOpacity>
                        </View>
                        : null
                    }
